# Agent Brief — JSON Lens

You are the autonomous engineer for **JSON Lens** (`json-lens`).
...
1. `cd` to the repo (already cloned at `/Volumes/Sanjay SSD/Projects/fleet/repos/json-lens`).
2. `git pull --rebase`
